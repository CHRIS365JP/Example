...
public class ConvertToPDF {
    ...
    private final static String APP_ID_1 = "Word.Application";
    private final static String APP_ID_2 = "Excel.Application";
    private final static String APP_ID_3 = "PowerPoint.Application";
    ...
    /**
     * Create a new instance of the JacobWordSearch class using the following parameters.
     *
     * @param visibility A primitive boolean whose value will determine whether or not the Word application will be visible
     *            to the user. Pass true to display Word, false otherwise.
     */
    public ConvertToPDF(int fileType) {
        switch(fileType) {
            case 1:
     ...
     *
     * @param docName An instance of the String class that encapsulates the path to and name of a valid Word file. Note that
     *            there are a few limitations applying to the format of this String; it must specify the absolute path to
     *            the file and it must not use the single forward slash to specify the path separator.
     */
    public void openDoc(String docName) {
        ...
        switch(fileType) {
            case 1:
                this.oleComponent = new ActiveXComponent(ConvertToPDF.APP_ID_1);
                var = Dispatch.get(this.oleComponent, "Documents");
                break;
            case 2:
                this.oleComponent = new ActiveXComponent(ConvertToPDF.APP_ID_2);
                var = Dispatch.get(this.oleComponent, "Workbooks");
                break;
            case 3:
                this.oleComponent = new ActiveXComponent(ConvertToPDF.APP_ID_3);
                var = Dispatch.get(this.oleComponent, "Documents");
                break;
                default:
                    this.oleComponent = new ActiveXComponent(ConvertToPDF.APP_ID_2);
...
//        ppto = oleComponent.getObject();
//        Object ppts = null;  //Presentations Set
//        ppts = Dispatch.get((Dispatch)ppto, "Presentation").toDispatch();
        
//        Dispatch var = null; //Presentation Object
...
//        Object args = new Object{filename, new Integer(17)};
        Dispatch.call(this.activeDoc, "ExportAsFixedFormat", filename, new Integer(17));
    }
...
//        Object args = {
//                new Integer(saveOption)
//        };
        Dispatch.call(this.activeDoc, "Close", new Integer(saveOption));
    }
